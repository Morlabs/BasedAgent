	...
	return (
		<div>
			...
			<div className="content">
				...
				<p>
					With features such as advanced coding assistance, bug detection, and optimization tips, Based Agent
					streamlines the development process, empowering builders to focus on creating innovative applications. Based
					Agent combined with the strengths of the Morpheus ecosystem, create a powerful tool for building decentralized
					AI.
				</p>
				<p>
					Following the principles of the MOR20 fair launch model, we ensure a transparent and community-driven approach
					to funding and development. This approach allows for equitable participation and rewards for all contributors,
					creating a sustainable and decentralized ecosystem.
				</p>
				<p>
