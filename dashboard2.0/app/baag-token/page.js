		...
		<div>
			...
			<div className="content">
				...
				<section className="utility-section">
					...
					<div className="column">
						...
						<p>BAAG tokens also function as a form of collateral that reviewers can post as a guarantee of the quality
							and integrity of their reviews. This collateral is at risk of being slashed if a review is subsequently
							found to be incorrect or introduces a critical error, thereby enforcing high standards and accountability
							within the review process.</p>
						<p>BAAG is the designated currency for all settlements between parties that directly contribute to the Based
							Agent ecosystem, facilitating a streamlined and unified transaction process.</p>
					</div>
				</section>
				<section className="distribution-section">
					...
					<div className="column">
						<p>The distribution will start with four Morpheus contributor groups earning the tokens by providing forms
							of proof of work (labor) and proof of stake (capital) to the network:</p>
						<ul>
