...
const LanguagesAndTechnologies = ({languages, technologies}) => {
  return (
...
const UserLanguages = ({ languages }) => {
  return (
    <div className="p-5">
      <div className="text-lg font-semibold mb-4 hover:underline uppercase cursor-pointer">
        language overview
      </div>
...
const UserTechnologies = ({ technologies }) => {
  return (
    <div className="p-5">
      <div className="text-lg font-semibold uppercase mb-4 hover:underline cursor-pointer">
        technologies
      </div>
      <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 mt-4">
