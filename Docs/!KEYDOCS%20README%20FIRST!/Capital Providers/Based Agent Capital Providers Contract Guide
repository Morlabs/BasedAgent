# Based Agent Capital Providers Contract Guide

## Introduction
The purpose of the guide is to pass you through the process of direct interaction with the Based Agent Capital Providers Distribution Contract.
...
**Ethereum:**
- Based Agent Distribution Contract: [insert](insert) 
...
Input parameters:
- `spender`: **Distribution contract** address: `insert`;
...
After confirmation, you need to go to the [Distribution](https://etherscan.io/address/insert#writeProxyContract) contract, open the **“Contract”** tab, then the **“Write as Proxy”** tab.   
...
## What is the amount of BAAG rewards earned? 

You need to go to the [Distribution](https://etherscan.io/address/insert#readProxyContract) contract, open the **“Contract”** tab, then the **“Read as Proxy”** tab. 
...
Go to the [Distribution](https://etherscan.io/address/insert#writeProxyContract) contract, open the **“Contract”** tab, then the **“Write as Proxy”** tab.  
